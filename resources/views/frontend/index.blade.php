...
{{--							<img class="m-b-1 m-rl-8" src="images/icons/icon-night.png" alt="IMG">--}}
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="images/icons/logo_tm.jpg" alt="IMG-LOGO"></a>
            </div>
...
{{--            <!-- Logo desktop -->--}}
{{--            <div class="logo">--}}
{{--                <a href="index.html"><img src="{{asset('images/icons/logo-02.jpg')}}" alt="LOGO"></a>--}}
{{--            </div>--}}
            ...
            <div class="main-nav">
                ...
                <nav class="menu-desktop">
                    <a class="logo-stick" href="index.html">
                        <img src="images/icons/logo_tm.jpg" alt="LOGO">
                    </a>
